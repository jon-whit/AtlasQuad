...
INCLUDE_PATHS = -I. -I./ITG3200 -I./ADXL345 -I./PID -I./motors -I./XBeeLib -I./XBeeLib/FrameBuffer -I./XBeeLib/FrameHandlers -I./XBeeLib/Frames -I./XBeeLib/IO -I./XBeeLib/RemoteXBee -I./XBeeLib/Utils -I./XBeeLib/XBee -I./XBeeLib/XBee802 -I./XBeeLib/XBeeZB -I./XBeeLib/DigiLogger -I./mbed -I./mbed/TARGET_NUCLEO_F072RB -I./mbed/TARGET_NUCLEO_F072RB/TARGET_STM -I./mbed/TARGET_NUCLEO_F072RB/TARGET_STM/TARGET_STM32F0 -I./mbed/TARGET_NUCLEO_F072RB/TARGET_STM/TARGET_STM32F0/TARGET_NUCLEO_F072RB -I./mbed/TARGET_NUCLEO_F072RB/TOOLCHAIN_GCC_ARM 
